...
import com.web.hyundai.model.home.HomeCarBannerDto;
import com.web.hyundai.repo.car.CarRepo;
import com.web.hyundai.repo.home.HomeCarBannerRepo;
...
public class HomeController {
    ...
    @Autowired
    private HomeCarBannerRepo homeCarBannerRepo;


    @PostMapping("/admin/home/banner")
    public ResponseEntity<HomeCarBanner> createHomeCarBanner(
            ...
            throws IOException {
        return carBuildService.createHomeCarBanner(id, vehicleType, link, visibility, image);
    }

    @GetMapping("/api/home/banner/{bannerType}")
    public ResponseEntity<HomeCarBanner> getHomeCarBanner(@PathVariable VehicleType bannerType) {
        HomeCarBanner homeCarBanner = homeCarBannerRepo.findByVehicleType(bannerType.name());
        if (null != homeCarBanner) {
            return ResponseEntity.ok(homeCarBanner);
        }
        return ResponseEntity.notFound().build();
    }

    @GetMapping("/admin/home/banner")
    public ResponseEntity<List<HomeCarBanner>> getAllHomeCarBanner() {
        return ResponseEntity.ok(homeCarBannerRepo.findAll());
    }
    ...
    public List<HomeCarWeb> getAllCars(
    ...
    public ResponseEntity<String> deleteSlider(@PathVariable Long sliderId) {
