...
public class DataSave {
    ...
    public void saveTestCar(){
        ...
        if(carRepo.findAll().size() < 1) {
            ...
            Engine engine = new Engine(1L, "1.6 benzini", 350, 1600, "image",fuelUsage,car);
            Engine engine2 = new Engine(2L, "1.6 benzini", 3503, 16030, "image",fuelUsage,car);
            engineRepo.save(engine);
            engineRepo.save(engine2);

            EngineDesc engineDesc = new EngineDesc("chveni dzravi sauketesoa", "საუკეთესოა",engine);
